        ...
        <>
            ...
            <section className='home-banner-section' id='home'>
                <div className="container">
                    ...
                    <p data-aos="fade-up"
                        data-aos-duration="2000">Charge your EV with clean, sustainable energy.
                ...
                <div className="container">
                    <div className="row row-gap-4 align-items-center overflow-hidden">
                        <div className="col-sm-12 col-md-6 col-lg-6" >
                            <img src="../../assets/images/circle-img.png" alt="circle-img" data-aos="fade-right"
                                data-aos-duration="1500" />
                            <img src="../../assets/images/about-img.jpg" alt="about-img" data-aos="fade-right"
                                data-aos-duration="1500" />
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-6" data-aos="fade-left"
                            ...
                            <p>Experience the ultimate in convenience and reliability with our top-tier car charging solutions. We offer fast, efficient, and eco-friendly charging to keep you on the road with peace of mind. Trust us for the best charging experience, anytime and anywhere.</p>
                            <AboutAccordion />
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="d-flex align-items-center justify-content-between flex-wrap" data-aos="fade-up"
                        ...
                        <div>
                            ...
                            <h2>Premier Service Providers <span className="d-block">for Electric Vehicles</span></h2>
                        </div>

                        <a href="#" className='primary-color'>See All <img src="../../assets/images/service-arrow.svg" alt="arrow" style={{ width: '30px' }} /></a>
                    </div>
                ...
                <div className="container">
                    <div className="row align-items-center row-gap-4">
                        <div className="col-sm-12 col-md-6- col-lg-6" data-aos="fade-up"
                            ...
                            <h2>Your Safety is Our <span className="d-block">Top Priority.</span></h2>
                            <p>Rostrum exercitationem ullam corporis suscipit laboriosam, nisiae commodi consenuatur reprehenderit.</p>
                            <a href="#" className="primary-btn">Get Started <img src="../../assets/images/arrow.svg" alt="arrow" /></a>
                        </div>
                        <div className="col-sm-12 col-md-6- col-lg-6">
                            <CounterSection />
                        </div>
            ...
            <section className="featured-section">
                <div className="container">
                    <SubText text='Our Features' data-aos="fade-up"
                        data-aos-duration="1000" />
                    <h2 data-aos="fade-up"
                        data-aos-duration="1000">Key Features of Energox <span className="d-block">EV Charging</span> </h2>
                    ...
                    <div className="row align-items-center overflow-hidden">
                        <div className="col-sm-12 col-md-6 col-lg-3" data-aos="fade-right"
                            ...
                            <div className='feature-div'>
                                ...
                                <h4>High Quality</h4>
                                <p>Duis aute irure dolor in repren in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                            </div>
                            <div className='feature-div'>
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6" data-aos="fade-up"
                            data-aos-duration="1000">
                            <div>
                                <img src="../../assets/images/car-charging-img.png" alt="" width='100%' />
                            </div>
                        </div>
                ...
                <div className="d-flex align-items-center flex-wrap">
                    ...
                    <div className="half-section half-content-section">
                        <div className='d-flex flex-column justify-content-center h-100'>
                            ...
                            <h2 data-aos="fade-up"
                                data-aos-duration="1000">Embracing <span className="d-block">Sustainable Travel</span></h2>
                            <p data-aos="fade-up"
                                data-aos-duration="1000">Nostrum exercitationem ullam corporis suscipit laboriosam, aliuid commodi consenuatur reprehenderit in voluptate velit incididunt ut labore aet dolore magna.</p>
                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <p className='description' data-aos="fade-up"
                                data-aos-duration="3000">Nostrum exercitationem ullam corporis suscipit laboriosam, nisiaeruo aliuid commodi consenuatur reprehenderit in voluptate velit esse cia incididunt ut labore aet dolore magna.</p>
                        </div>
            ...
            <section className='faq-section'>
                <div className="container">
                    <SubText text='Faqs' />
                    <h2 data-aos="fade-up"
                        data-aos-duration="3000">Frequently Asked Questions</h2>
                    <div className="row">
                        <FaqAccordion />
                    </div>
                </div>
